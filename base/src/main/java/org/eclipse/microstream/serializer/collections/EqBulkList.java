...
import org.eclipse.microstream.serializer.collections.old.AbstractBridgeXList;
...
import org.eclipse.microstream.serializer.util.iterables.GenericListIterator;
...
public final class EqBulkList<E> extends AbstractSimpleArrayCollection<E> implements XList<E>, Composition
{
	...
	public long remove(final E element)
	{
		...
		this.size -= removeCount = XArrays.removeAllFromArray(
	...
	public long removeAll(final XGettingCollection<? extends E> elements)
	{
		 ...
		 */
		final int removed;
		this.size -= removed = XArrays.removeAllFromArray(

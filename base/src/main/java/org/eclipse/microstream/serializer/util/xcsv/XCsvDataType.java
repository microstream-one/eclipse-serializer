package org.eclipse.microstream.serializer.util.xcsv;
...
import org.eclipse.microstream.serializer.exceptions.XCsvException;
...
public enum XCsvDataType
{
	...
	final static org.eclipse.microstream.serializer.util.xcsv.XCSV.ValueSeparatorWeight vc(final char valueSeparator, final double weight)
	{
		return new org.eclipse.microstream.serializer.util.xcsv.XCSV.ValueSeparatorWeight.Default(
			org.eclipse.microstream.serializer.util.xcsv.XCSV.validateValueSeparator(valueSeparator),
			XMath.positive((float)weight)
		);
	}
	
	final static EqConstHashTable<Character, org.eclipse.microstream.serializer.util.xcsv.XCSV.ValueSeparatorWeight> map(final org.eclipse.microstream.serializer.util.xcsv.XCSV.ValueSeparatorWeight... weights)
	{
		final EqHashTable<Character, org.eclipse.microstream.serializer.util.xcsv.XCSV.ValueSeparatorWeight> table = EqHashTable.New();
		
		for(final org.eclipse.microstream.serializer.util.xcsv.XCSV.ValueSeparatorWeight weight : weights)
		{
	...
	final static char determinePreferredValueSeparator(
		final Iterable<? extends org.eclipse.microstream.serializer.util.xcsv.XCSV.ValueSeparatorWeight> weights
	)
	{
	...
	private final EqConstHashTable<Character, org.eclipse.microstream.serializer.util.xcsv.XCSV.ValueSeparatorWeight> valueSeparatorWeights;
	...
	public final EqConstHashTable<Character, org.eclipse.microstream.serializer.util.xcsv.XCSV.ValueSeparatorWeight> valueSeparatorWeights()
	{

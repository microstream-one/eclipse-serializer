...
import org.eclipse.microstream.serializer.persistence.binary.internal.AbstractBinaryHandlerCustomIterableSimpleListElements;
...
public class BinaryHandlerGenericSet<T extends Set<?>> extends AbstractBinaryHandlerSet<T>
{
	...
	{
		final org.eclipse.microstream.serializer.functional.Instantiator<T> instantiator = XReflect.WrapDefaultConstructor(type);
	...
	public T create(final Binary data, final PersistenceLoadHandler handler)
	{
		return this.instantiator.instantiateSet(
			AbstractBinaryHandlerCustomIterableSimpleListElements.getElementCount(data)
		);
	}

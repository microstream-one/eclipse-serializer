...
import org.eclipse.microstream.serializer.persistence.types.PersistenceFieldEvaluator;
import org.eclipse.microstream.serializer.tests.model.FieldEvaluatorExample;
...
public class FieldEvaluatorTest {
    ...
    void standard() throws Exception {
        ...
        Assertions.assertThat(example.getValue()).isEqualTo("Foo");
        Assertions.assertThat(example.getIgnored()).isEqualTo(0);  //Because we don't have standard constructor and class creation
        Assertions.assertThat(example.get_internalField()).isEqualTo("anotherValue");
    ...
    void customEvaluator() throws Exception {
        ...
        Assertions.assertThat(example.getValue()).isEqualTo("Foo");
        Assertions.assertThat(example.getIgnored()).isEqualTo(0);  //Because we don't have standard constructor and class creation
        Assertions.assertThat(example.get_internalField()).isNull();  //Because we don't have standard constructor and class creation
